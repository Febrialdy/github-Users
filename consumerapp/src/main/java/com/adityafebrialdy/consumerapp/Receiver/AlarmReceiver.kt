package com.adityafebrialdy.consumerapp.Receiver
...
class AlarmReceiver : BroadcastReceiver() {
  ...
  fun setRepeatingAlarm(context: Context, type: String, message: String){
    ...
    calendar.set(Calendar.HOUR_OF_DAY, Integer.parseInt("9"))
    calendar.set(Calendar.MINUTE, Integer.parseInt("0"))
    calendar.set(Calendar.SECOND, 0)
  ...
  fun cancelAlarm(context: Context, type: String){
    ...
    Toast.makeText(context, "Reminder inactive", Toast.LENGTH_SHORT).show()
  }
